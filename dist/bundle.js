...
(function e(t, n, r) {
  function s(o, u) {
    ...
    module.exports = !_dereq_(29) && !_dereq_(35)(function () {
      return Object.defineProperty(_dereq_(30)('div'), 'a', { get: function get$$1() {
          return 7;
        } }).a != 7;
    });
    ...
    exports.f = _dereq_(29) ? Object.defineProperty : function defineProperty$$1(O, P, Attributes) {
      anObject(O);
    ...
    module.exports = {
      ...
      function (test, buggy, set$$1) {
        try {
          set$$1 = _dereq_(25)(Function.call, _dereq_(75).f(Object.prototype, '__proto__').set, 2);
          set$$1(test, []);
    ...
    function get$$1(view, bytes, index, isLittleEndian) {
      var numIndex = +index;
    ...
    var defineProperty$$1 = _dereq_(72).f;
    module.exports = function (name) {
    ...
    _dereq_(22)(WEAK_SET, function (get$$1) {
    ...
    var wrap = function wrap(set$$1) {
      return MSIE ? function (fn, time /* , ...args */) {
        return set$$1(invoke(partial, [].slice.call(arguments, 2),
        // eslint-disable-next-line no-new-func
...
var JSON_DATA_URL = 'https://unpkg.com/newrelic-host-applications@1.3.0/src/host-app-data.json';
var MAX_HOST_APPS_LIMIT = 5;

var globalActionTypes = {
  GET_JSON_DATA_REQUEST: 'GLOBAL/GET_JSON_DATA_REQUEST',
  SET_LIST_DATA: 'GLOBAL/SET_LIST_DATA',
  GET_JSON_DATA_ERROR: 'GLOBAL/GET_JSON_DATA_ERROR'
};

function setListData(data) {
  return {
    type: globalActionTypes.SET_LIST_DATA,
    payload: { data: data }
  };
}

function jsonDataError(error) {
  return {
    type: globalActionTypes.GET_JSON_DATA_ERROR,
    error: error
  };
}
...
function _updateListeners(listeners) {
  ...
  if (listeners) {
    listeners.forEach(function (listener) {
      ...
      var elements = document.querySelectorAll('[data-evt="' + target + '"]');

      [].forEach.call(elements, function (element) {
        element.removeEventListener(type, callback);
        var finalCallback = state ? function (event) {
...
function onClickApplication(application) {
  return {
    type: actionTypes.ON_CLICK_APPLICATION,
...
function _onClickApplication(evt, state) {
  ...
  AppsByHostSite$1.dispatch(onClickApplication(clickedApp));
}
...
function toggleStyle(isSelected) {
  return {
    type: actionTypes$1.TOGGLE_STYLE,
  ...
  createClass(AppsByHostSite, [{
    ...
    value: function init() {
      ...
      request$$1.then(function (data) {
        ...
        var lib = new NewRelicHostApps(parsedData);
        var listData = lib.hostsList.map(function (host) {
          return {
            host: host,
            applications: lib.getTopAppsByHost(host, MAX_HOST_APPS_LIMIT)
          };
        });
        _this.dispatch(setListData(listData));
      }).catch(function (error) {
        return _this.dispatch(jsonDataError(error));
      });
    }
  }]);
  return AppsByHostSite;
}();

var AppsByHostSite$1 = new AppsByHostSite();

AppsByHostSite$1.init();
